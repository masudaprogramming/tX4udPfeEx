...
<html>
    ...
    <br><br>
    [<A href="customer.php?type=message_box&action=transmit">送信BOXへ</A>]
    ...
    <table  border="1" width="700" cellspacing="0" cellpadding="4">
        <tr>
            ...
            <th width="15%" ><font color="blue">送信日時</font></th>
    ...
    {foreach item=item from=$data}
        <tr>
            ...
            <td><A href="customer.php?type=detail_message&action=receive&message_id={$item.id}">{$item.body|truncate:10:' >>'|escape:"html"}</A></td>
